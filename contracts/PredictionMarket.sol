...
contract PredictionMarket is ReentrancyGuard {
    ...
    function createTopic(
        ...
        newTopic.totalPool = betAmount;

        emit TopicCreated(topicId, msg.sender, title, betAmount);
    }
     ...
     */
    function joinTopic(uint256 topicId, uint256 choice) external nonReentrant {
        ...
        // 转入第二个玩家的投注金额
        usdcToken.safeTransferFrom(msg.sender, address(this), topic.betAmount);
        topic.totalPool += topic.betAmount;
    ...
    function claimReward(uint256 topicId) external nonReentrant {
        ...
        usdcToken.safeTransfer(topic.winner, reward);
